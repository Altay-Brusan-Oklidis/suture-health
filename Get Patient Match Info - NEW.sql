...
----*************************************************************************************************************************************************************
	...
	SET @PatientLastName 		= 'Hext'			--Choose either this OR @Submittedby 
...
--SET @PatientIdToUpdate  			= -1			--UPDATE PATIENT: SET TO EXISTING PATIENT ID ... or ... CREATE NEW PATIENT: SET TO -1

--SET @PatientMatchLogIdToUpdate  	= 582274		--SET TO THE MATCH PATIENT LOG ID THAT YOU WANT TO USE TO CREATE OR UPDATE THE PATIENT
