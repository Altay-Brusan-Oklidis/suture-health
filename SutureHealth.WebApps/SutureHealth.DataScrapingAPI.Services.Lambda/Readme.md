...
Execute unit tests
```
    cd "SutureHealth.DataScrapingAPI.Services.Lambda/test/SutureHealth.DataScrapingAPI.Services.Lambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "SutureHealth.DataScrapingAPI.Services.Lambda/src/SutureHealth.DataScrapingAPI.Services.Lambda"
