CREATE TABLE [shapi].[ProviderRelationship] (
    ...
    CONSTRAINT [FK_provider_user_facility_provider_facility_provider_id] FOREIGN KEY ([FacilityProviderId]) REFERENCES [shapi].[Provider] ([ProviderId]),
    CONSTRAINT [FK_provider_user_facility_provider_user_provider_id] FOREIGN KEY ([UserProviderId]) REFERENCES [shapi].[Provider] ([ProviderId])
);


GO
CREATE NONCLUSTERED INDEX [IX_provider_user_facility_facility_provider_id]
    ON [shapi].[ProviderRelationship]([FacilityProviderId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_provider_user_facility_user_provider_id]
    ON [shapi].[ProviderRelationship]([UserProviderId] ASC);
