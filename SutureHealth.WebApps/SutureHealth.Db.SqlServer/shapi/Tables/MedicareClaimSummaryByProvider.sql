CREATE TABLE [shapi].[MedicareClaimSummaryByProvider] (
    ...
    CONSTRAINT [FK_provider_medicare_claims_by_provider_provider_provider_id] FOREIGN KEY ([ProviderId]) REFERENCES [shapi].[Provider] ([ProviderId])
);


GO
CREATE NONCLUSTERED INDEX [IX_provider_medicare_claims_by_provider_provider_organization_npi]
    ON [shapi].[MedicareClaimSummaryByProvider]([ProviderOrganizationNPI] ASC);
