CREATE TABLE [shapi].[MedicareClaimSummaryByProviderAndFile] (
    ...
    CONSTRAINT [FK_provider_medicare_claims_by_provider_and_file_provider_provider_id] FOREIGN KEY ([ProviderId]) REFERENCES [shapi].[Provider] ([ProviderId])
);


GO
CREATE NONCLUSTERED INDEX [IX_provider_medicare_claims_by_provider_and_file_provider_organization_npi_file]
    ON [shapi].[MedicareClaimSummaryByProviderAndFile]([ProviderOrganizationNPI] ASC, [File] ASC);
