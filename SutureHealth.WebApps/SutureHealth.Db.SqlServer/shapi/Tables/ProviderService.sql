CREATE TABLE [shapi].[ProviderService] (
    ...
    CONSTRAINT [FK_provider_service_provider_provider_id] FOREIGN KEY ([ProviderId]) REFERENCES [shapi].[Provider] ([ProviderId]),
...
CREATE NONCLUSTERED INDEX [IX_provider_service_provider_id]
    ON [shapi].[ProviderService]([ProviderId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_provider_service_service_id]
    ON [shapi].[ProviderService]([ServiceId] ASC);
