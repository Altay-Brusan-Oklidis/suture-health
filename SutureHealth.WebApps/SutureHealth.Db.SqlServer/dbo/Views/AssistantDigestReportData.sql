CREATE VIEW [dbo].[AssistantDigestReportData]
AS 
                ...
                WHEN US.ItemVarChar like 'All|False%' THEN 
                    CASE
                        WHEN r.AT IS NOT NULL THEN
                            CASE
                                WHEN r.at is NULL AND r.ht IS NULL THEN 1
                                WHEN r.ht IS NOT NULL AND ht.userid = um.userid THEN 1
                                ELSE 0
                            END
