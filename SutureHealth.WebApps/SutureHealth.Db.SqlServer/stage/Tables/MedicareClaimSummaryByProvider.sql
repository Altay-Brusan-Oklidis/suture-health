CREATE TABLE [stage].[MedicareClaimSummaryByProvider] (
    ...
    CONSTRAINT [FK_provider_medicare_claims_by_provider_provider_provider_id] FOREIGN KEY ([ProviderId]) REFERENCES [stage].[Provider] ([ProviderId])
);


GO
CREATE NONCLUSTERED INDEX [IX_provider_medicare_claims_by_provider_provider_organization_npi]
    ON [stage].[MedicareClaimSummaryByProvider]([ProviderOrganizationNPI] ASC);
