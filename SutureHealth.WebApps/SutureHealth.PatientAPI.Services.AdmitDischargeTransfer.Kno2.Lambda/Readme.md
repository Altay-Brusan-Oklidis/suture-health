...
WORKDIR /src
COPY ["SutureHealth.PatientAPI.Services.Kno2.Lambda.csproj", "SutureHealth.PatientAPI.Services.Kno2.Lambda/"]
RUN dotnet restore "SutureHealth.PatientAPI.Services.Kno2.Lambda/SutureHealth.PatientAPI.Services.Kno2.Lambda.csproj"

WORKDIR "/src/SutureHealth.PatientAPI.Services.Kno2.Lambda"
COPY . .
RUN dotnet build "SutureHealth.PatientAPI.Services.Kno2.Lambda.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "SutureHealth.PatientAPI.Services.Kno2.Lambda.csproj" \
...
Execute unit tests
```
cd "SutureHealth.PatientAPI.Services.Kno2.Lambda/test/SutureHealth.PatientAPI.Services.Kno2.Lambda.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "SutureHealth.PatientAPI.Services.Kno2.Lambda/src/SutureHealth.PatientAPI.Services.Kno2.Lambda"
