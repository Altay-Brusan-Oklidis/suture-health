...
namespace MessageSenderAgent.Builder
{
    ...
    public class PIDSegmentBuilder
    {
        ...
        public PIDSegmentBuilder(string SetId, AddressBuilder addressBuilder) 
        {
        ...
        public PatientModel Build() 
        {
            ...
            {
                Id = Utilities.GetRandomAlphabeticString(2) + "-" + Utilities.GetRandomDecimalString(3),
        ...
        public PatientModel PatientModel { get { return patientModel; } }
    }
}
