...
{
    public class MDM_T02MessageBuilder
    {
        ...
        public MDM_T02 Build() 
        {
            ...
            MessageType messageType = new() { Code = MessageCodeType.MDM, Sturcture = MessageStructureType.MDM_T02, Trigger = TriggerEvent.T02 };
